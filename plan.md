...
- [x] 射程攻撃（歩兵 射程1・ATK3・DEF2・兵力10、乱数なし）
- [x] ダメージ・撃破（兵力0）・損害率（負傷含む）
- [x] 将軍 1/陣営（仮）・将軍0で即敗北
- [x] 勝敗判定 §4.4（期間20ハーフターン引分 / 将軍0 / 損害50%）
- [x] 結果表示後操作ロック

**完了条件:** 1 マップで勝敗または引き分けがつく。  
**状態 (2026-07-22):** #7 承認後、experimental に実装。
...
| 2026-07-22 | Phase 3 (#7 承認): A攻撃・将軍仮・損害/期間/将軍0の勝敗 |
